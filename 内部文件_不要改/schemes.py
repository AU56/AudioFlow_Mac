...
SCHEMES = [
    {
        ...
        "tag": "无损", "tag_bg": "#1a3d25", "tag_fg": "#4ed87a",
        "desc": "轻量保真处理，低频和高频保留更多，适合单独使用或作为第一步。",
    ...
    {
        "index": 3, "num": "三", "id": "J", "name": "自由实验",
        "tag": "实验", "tag_bg": "#1e1030", "tag_fg": "#a78bfa",
    ...
    },
    {
        ...
        "tag": "保真", "tag_bg": "#0d1e2e", "tag_fg": "#38bdf8",
    ...
    {
        "index": 6, "num": "六", "id": "F", "name": "SoX标准",
        "tag": "SoX", "tag_bg": "#0d1e2e", "tag_fg": "#38bdf8",
    ...
    {
        "index": 8, "num": "八", "id": "H", "name": "重低频",
        "tag": "厚度", "tag_bg": "#0d1e2e", "tag_fg": "#38bdf8",
    ...
    {
        "index": 17, "num": "十七", "id": "R", "name": "电音低频保真",
        "tag": "电音", "tag_bg": "#102a2a", "tag_fg": "#5eead4",
        "desc": "给低频重、鼓组密的曲子用，减少扁平化，保留尾段能量和空气感。",
        "engine": "sox", "role": "电音保真",
        "sox_args": ["highpass", "22", "pitch", "-16", "bass", "1.2",
                     "treble", "-0.10", "9000", "treble", "-0.8", "12500",
                     "treble", "-1.4", "16000", "lowpass", "17000",
                     "reverb", "9", "28", "40", "46",
                     "gain", "-n", "-1.3", "rate", "48000", "dither", "-s"],
    },
]
